...
void GetFileSHA1a(char *FileNameInPut)  
{  
...
char *GetFileSHA1b(char *FileNameInPut, char *outSHA1, char *outError)  
{  
    if(FileNameInPut==NULL)   
    {  
        if (outError != NULL)  
    ...
    {  
        if (outError != NULL)  
        {  
            sprintf(outError, "open file\"%s\"fail\n", FileNameInPut);  
        }  
        return outSHA1;  
    }  
    sha1_init (&ctx);  
    ...
    {  
        if (outError != NULL)  
        {  
            sprintf(outError, "read file \"%s\" fail\n", FileNameInPut);  
        }  
        return outSHA1;  
    }  
    sha1_final (&ctx);  
